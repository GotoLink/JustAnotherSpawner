...
public enum CreatureTypeRegistry {
    ...
    public void initializeFromConfig(File configDirectory, MinecraftServer minecraftServer) {
        ...
        String customNames = masterConfig.get("Extra Categories", "Additions", "", comment).value.toUpperCase();
        customNames = worldConfig.get("Extra Categories", "Additions", customNames, comment).value.toUpperCase();
